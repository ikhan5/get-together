...
INSERT INTO `memberships` (`id`, `user_id`, `account_id`) VALUES
(1, 1, 1),
(2, 2, 2),
(3, 5, 2),
(4, 4, 2),
...
--
ALTER TABLE `memberships`
  ADD CONSTRAINT `fk_membership_account_id` FOREIGN KEY (`account_id`) REFERENCES `accounts` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_membership_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
